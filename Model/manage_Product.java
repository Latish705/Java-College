...
public class manage_Product extends fileHandling_Product implements Displayable {
    ...
    public manage_Product(){
        readJsonFile("./Model/product.json");
    }
    ...
    @Override
    public void writeJsonFile(ArrayList<Product> products, String filePath) {
...
//    }
    ...
    public void delete(String id) {
        ...
        Products = readJsonFile("./Model/MOCK_DATA.json");

        // Find the index of the object with the specified 'id' and remove it
        int indexToDelete = -1;
        for (int i = 0; i < Products.size(); i++) {
            Product Product = Products.get(i);
            if (Product.getProduct_id() == Integer.parseInt(id)) { // Convert id to an integer for comparison
                indexToDelete = i;
                break;
            }
        }
        ...
        writeJsonFile(Products, "./Model/MOCK_DATA.json");
    }
